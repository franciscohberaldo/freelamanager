...
export const invoiceT = {
  pt: {
    ...
    brazilianPayment:     "Pagamento nacional",
    bankBranchAccount:    "Banco, Agência, Conta",
    agency:               "Agência",
  ...
  en: {
    ...
    brazilianPayment:     "Brazilian payment",
    bankBranchAccount:    "Bank, Branch, Account",
    agency:               "Branch",
