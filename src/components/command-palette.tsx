...
import { Search, Briefcase, Users, FileText, History, LayoutDashboard, ClipboardList, CalendarDays, Calculator, Settings, TrendingUp, Wallet, Receipt } from "lucide-react"
...
const STATIC_LINKS: Result[] = [
  ...
  { id: "hist",    label: "Histórico de jobs", href: "/historico", icon: History,         category: "Páginas" },
